...
- **硬件平台对比**：Micro:bit、ESP32、大疆、树莓派、Arduino、51系列六大平台横向对比
- **学习路径**：为 4 个不同年龄段孩子定制的渐进式学习路径
- **家长指南**：认知发展、安全指南、竞赛备赛、资源汇总
- **AI 辅助学习**：如何利用 ChatGPT/Claude 等 AI 工具辅助科创教育
...
└── Track-D-10yo-Advanced/             # 10-12岁竞赛冲刺路径 (10 节点)
    ...
    └── D10-综合冲刺.md
│
├── 05-Parent-Guide/                   # 家长指南 (9 项)
│   ├── AI辅助科创教育指南.md           # 🆕 AI辅助学习指南
│   ├── 儿童认知发展指南.md
│   ├── 电子安全指南.md
│   ├── 竞赛备赛指南.md
│   ├── 中国创客资源大全.md
...
│   └── 屏幕时间与数字健康.md
│
└── 06-Hardware-Platform-Comparison.md # 硬件平台横向对比
```
...
本知识库提供了六大主流硬件平台的详细横向对比，帮助家长为孩子选择合适的开发平台：

| 平台 | 适合年龄 | 核心优势 | 价格区间 |
|------|----------|----------|----------|
| **Micro:bit** | 7-12岁 | 零门槛入门，内置传感器丰富 | ¥100-200 |
| **ESP32** | 10-16岁 | WiFi/蓝牙内置，性价比极高 | ¥20-80 |
| **大疆系列** | 9-19岁 | 工业品质，赛事体系完善 | ¥2000-5000 |
| **树莓派** | 12-18岁 | 完整Linux系统，扩展性强 | ¥200-500 |
| **Arduino** | 10-16岁 | 生态最大，资料最丰富 | ¥30-150 |
| **51系列** | 12-18岁 | 理解硬件原理，成本最低 | ¥10-30 |

👉 **详细对比请查看**：[硬件平台横向对比](06-Hardware-Platform-Comparison.md)
...
本知识库新增了 AI 辅助科创教育指南，帮助家长利用 ChatGPT、Claude 等 AI 工具：

- **发现兴趣点**：通过 AI 分析孩子的学习行为和兴趣方向
- **设计实验**：让 AI 根据孩子水平和可用材料生成个性化项目
- **调试硬件**：使用标准化模板向 AI 描述问题，获得精准帮助
- **苏格拉底式教学**：让 AI 用提问引导孩子，而不是直接给答案

👉 **详细指南请查看**：[AI辅助科创教育指南](05-Parent-Guide/AI辅助科创教育指南.md)
